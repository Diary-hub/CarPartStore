...
<?php
include('../configs/services.php');
include('../configs/userServices.php');
session_start();
...
<head>
    ...
    <link rel="stylesheet" href="../statics/css/authStyle.css">
                    ...
                    <div id="userform">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active in" id="signup">
                                ...
                                <form id="signup" action="auth.php" method="post">
                                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="userAddress" type="text" class="form-control" id="userAddress"
                                            required data-validation-required-message="Please enter your address."
                                            autocomplete="off">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="userPhone" type="tel" class="form-control" id="phone" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="userImg" type="text" class="form-control" id="userImg" required
                                            data-validation-required-message="Please enter image link"
                                            autocomplete="off">
                                        <p class="help-block text-danger"></p>
                                    </div>
                            ...
                            <div class="tab-pane fade in" id="login">
                                ...
                                <form id="login" method="post" action="../configs/login.php">
                                    <div class="form-group">
                                        <label> Your Email<span class="req">*</span> </label>
