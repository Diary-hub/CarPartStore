...
if (isset($_POST["send"])) {
    ...
    $mail->addAddress("as17176@auis.edu.krd");
    $mail->isHTML(true);
    $mail->Subject = $_POST['Subject'];
    $mail->Body = $_POST['Body'] . '  Sent from:   ' . $_POST['Email'];
    $mail->send();
}
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form method="post" name="sentMessage" action="contact.php">
                        <div class="control-group">
                            <input name="Name" type="text" class="form-control" id="name" placeholder="name" required="required" data-validation-required-message="Please enter your name" />
                        ...
                        <div class="control-group">
                            <input name="Subject" type="text" class="form-control" id="subject" placeholder="Subject" required="required" data-validation-required-message="Please enter your subject" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea name="Body" class="form-control" rows="8" id="message" placeholder="your message" required="required" data-validation-required-message="Please enter your message"></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
